...
print(("--------13_compiled_figs(saliniry-d18O-dD-depth_etc)_v201--------"))
...
st.header('Compiled figs Ver.201')
# st.subheader('(saliniry-d18O-dD-depth_etc)')

# st.write("data source:", ("Kodama et al. (2024) only"))
st.write(':blue[data source:]  Kodama et al. (2024) only')
...
##################################選択データ表示　2024/10/07###################################################################################################################
    ...
    # with表記 (推奨)
    with st.expander("selected data (for all data)", expanded=False):
