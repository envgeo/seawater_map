...
@author: toyoho
V112 使っていないコードを整理，v111までは残っている
"""
...
print(("--------11_salinity-d18O_reg-line_plot_v201--------"))
...
st.header('Salinity-d18O Ver.201')
...
#https://cafe-mickey.com/python/streamlit-9/
    ...
    ref_data = st.radio("data source (see home>about):", ("Kodama et al. (2024) only", "Kodama et al. (2024) with other reports", "NASA_database"), horizontal=True, args=[1, 0])
...
######  scalebarで制御してsubmitする場合 ################
    ...
    if ref_data == "Kodama et al. (2024) only":
        ...
        excel_file = 'dataset/d18O_NASA_all_Python_20250123.xlsx'
