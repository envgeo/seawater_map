...
######  scalebarで制御してsubmitする場合 ################
    ...
    fig0 = px.scatter(df1, x="Salinity", y="d18O", color="Depth_m_rev", trendline='ols',trendline_color_override='darkblue', 
                width=700,
                height=600,
    ...
    ###### Fig2 #######
    st.subheader('3D salinity-d18O-depth-temperature')
