...
######  scalebarで制御してsubmitする場合 ################
    ...
    fig1 = px.scatter(df1, x="Salinity", y="d18O", color="Depth_m_rev", trendline='ols',trendline_color_override='darkblue', 
                width=700,
                height=600,
    ...
    fig2=px.scatter_3d(df1, x='Salinity', y='d18O', z='Depth_m_rev',
